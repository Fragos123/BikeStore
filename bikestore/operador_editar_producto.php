...
$stmt = $conn->prepare("SELECT talla, stock FROM producto_tallas WHERE producto_id = ? AND activo = 1");
$stmt->bind_param("i", $producto_id);
$stmt->execute();
$result_tallas = $stmt->get_result();
$tallas_existentes = array();

while ($row = $result_tallas->fetch_assoc()) {
    $tallas_existentes[$row['talla']] = $row['stock'];
}
$stmt->close();

// Si no hay tallas en producto_tallas, usar la del producto (retrocompatibilidad)
if (empty($tallas_existentes) && !empty($producto['talla'])) {
    $tallas_existentes[$producto['talla']] = $producto['stock'];
}
    ...
    <div class="container">
        ...
        <div class="form-card">
            <div class="form-header">
                ...
                <p class="form-subtitle">Modifica la información del producto</p>
            </div>

            <div class="info-box">
                <div class="info-box-title">📝 Editando: <?php echo htmlspecialchars($producto['nombre']); ?></div>
                <div class="info-box-text">
                    ID del producto: #<?php echo str_pad($producto['id'], 4, '0', STR_PAD_LEFT); ?>
                </div>
            </div>
            ...
            <form class="product-form" action="procesar_operador_editar_producto.php" method="POST" onsubmit="return validarFormulario()">
                ...
                <div class="tallas-section">
                    ...
                    <p style="color: #64748b; font-size: 0.9rem; margin-bottom: 1rem;">
                        Modifica las tallas disponibles y su stock
                    </p>

                    <div class="tallas-grid">
                        <?php
                        $todas_tallas = ['XS', 'S', 'M', 'L', 'XL', 'XXL'];
                        foreach ($todas_tallas as $talla):
                            $tiene_talla = isset($tallas_existentes[$talla]);
                            $stock_actual = $tiene_talla ? $tallas_existentes[$talla] : 0;
                        ?>
                        <div class="talla-card <?php echo $tiene_talla ? 'selected' : ''; ?>" id="card-<?php echo $talla; ?>">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="dias_envio" name="dias_envio" class="form-input" 
                               value="<?php echo $producto['dias_envio']; ?>" min="1" max="60" required>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="peso" name="peso" class="form-input" 
                               value="<?php echo $producto['peso']; ?>" step="0.1" min="0">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="velocidades" name="velocidades" class="form-input" 
                               value="<?php echo $producto['velocidades']; ?>" min="1" max="50">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="imagen_principal" name="imagen_principal" class="form-input" 
                           value="<?php echo htmlspecialchars($producto['imagen_principal']); ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="imagen_6" name="imagen_6" class="form-input" 
                           value="<?php echo htmlspecialchars($producto['imagen_6']); ?>">
                </div>
