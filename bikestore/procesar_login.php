        ...
        if ($resultado->num_rows === 1) {
            ...
            if (password_verify($password, $usuario['password'])) {
                ...
                if (empty($errores)) {
                    ...
                    // ===== NUEVO: LÓGICA DE REDIRECCIÓN INTELIGENTE =====
                    if (isset($_POST['redirect']) && !empty($_POST['redirect'])) {
                        $redirect = $_POST['redirect'];
                        // Seguridad básica: Solo permitir redirecciones relativas (dentro del mismo sitio)
                        // Si no contiene "http", asumimos que es una URL interna segura
                    ...
                    // Redirigir según el rol del usuario (Comportamiento por defecto)
